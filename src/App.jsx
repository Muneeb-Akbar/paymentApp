  ...
  <div className="w-full md:w-1/2 p-6 bg-white shadow-md rounded-md">
    ...
    <div className="space-y-4 mt-12">
      <label className="flex items-center space-x-2 border border-gray-300 rounded-lg p-2 hover:bg-gray-50 transition">
        <input type="radio" name="payment" className="form-radio text-yellow-500" />
    ...
    <button className='mt-12 font-bold w-full bg-yellow-500 text-black py-3 rounded hover:bg-yellow-600 transition duration-200'>Complete Order</button>
  </div>
  ...
  <div className="w-full md:w-1/2 p-6 bg-white shadow-md rounded-md">
    ...
    <div className="flex justify-between items-center space-x-4">
      ...
      <div className="flex w-1/2">
        <input type="text" placeholder="Coupon Code" className="border border-gray-300 p-2 rounded-l w-full focus:outline-none" />
        <button className="bg-yellow-500 text-black px-4 rounded-r font-bold">Redeem</button>
      </div>
    </div>
    ...
    <p className="text-xs text-black mb-6 font-bold">
      By continuing, you have read & accepted the <a href="#" className="text-blue-500 underline">Terms of Service</a>
    </p>
    <button className="w-full bg-yellow-200 text-gray-500 py-3 rounded hover:bg-yellow-300 transition">Claim 100% refund within 15 days after training starts.</button>
  </div>
